...
class BookDetailsView extends StatelessWidget {
  ...
  BookDetailsView({Key? key, required this.book_code, required this.book_name}) : super(key: key);
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 10,),
                      Text(bookItem.bookName, style: montserratTextStyle(fontSize: 25,
                          color: Colors.black),),
                      const SizedBox(height: 10,),
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        ...
                        children: [
                          Text('by', style: montserratTextStyle(),),
                          const SizedBox(width: 5,),
                          Text(bookItem.bookAuthor, style: montserratTextStyle(
                              fontSize: 15, color: Colors.green),),
                          Text(' | ', style: montserratTextStyle(),),
                          const SizedBox(width: 5,),
                          Text(bookItem.publishedDate, style: montserratTextStyle(
                          ...
                          trailing: Padding(
                            ...
                            child: Text(
                              ...
                              style: montserratTextStyle(
                                  fontSize: 12, color: Colors.grey), maxLines: 1,),
                          ),
                          ...
                          GestureDetector(
                            onTap: () async {
                              if (bookItem.bookHired != bookItem.bookItem) {
                                ...
                                final result = bookController.checkIssuedOrNot(bookItem.bookCode, await SPHelper.getUserEmailSharedPreference());
                            ...
                            child: Container(
                              //width: 200,
                              width: authController.isAdmin.isTrue ? MediaQuery
                                  .of(context)
                                  .size
                                  .width / 3 : 200,
                              ...
                              child: Text(bookItem.bookHired == bookItem.bookItem
                                  ? 'Not available'
                                  : 'Borrow Book',
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text('Book Description', style: montserratTextStyle(
