...
const appPrimaryColor = Color(0xFFff4348);
const appSecondaryColor = Color(0xffffa629);
const appDarkColor = Color(0xFF1e2c45);
...
const appSecBackGroundColor = Color(0xff2196f3);
