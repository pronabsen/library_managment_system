...
class AdminHomeController extends GetxController{
  ...
  countBooks() async {
    try {
      QuerySnapshot _myDoc = await FirebaseFirestore.instance.collection('Books').get();
  ...
  countIssuedBook() async {
    try {
      QuerySnapshot _myDoc = await FirebaseFirestore.instance.collection('issued books').get();
      List<DocumentSnapshot> _myDocCount = _myDoc.docs;
